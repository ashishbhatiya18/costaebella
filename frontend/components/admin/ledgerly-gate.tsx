...
// Reused by any app restricted to the same narrow LEDGERLY_ADMIN_EMAILS
// whitelist as Ledgerly's own P&L/Tax Export tabs (currently Menuly and
// Intel-ly) — probes the same GET /api/ledgerly/access gate. Real
// enforcement is server-side either way; this just avoids dangling a UI
    ...
    return (
      <div className="mx-auto flex min-h-screen max-w-lg items-center px-5">
        <Card className="w-full p-10 text-center">
          ...
          <p className="mt-1 text-sm text-navy/60">This app is restricted to a small set of emails.</p>
        </Card>
      </div>
    );
  }
