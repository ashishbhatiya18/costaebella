...
const NAV_ITEMS = [
  { href: "/pantrly/dashboard/log-stock", label: "Log Stock", shortLabel: "Log", Icon: BoxIcon },
  ...
  { href: "/pantrly/dashboard/summary", label: "Stock Summary", shortLabel: "Summary", Icon: ChartIcon },
];
