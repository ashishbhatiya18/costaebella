...
// Auth is gated once, site-wide, by app/menuly/layout.tsx (AuthProvider +
...
const NAV_ITEMS = [
  { href: "/menuly/dashboard/items", label: "Menu Items", shortLabel: "Items", Icon: ListIcon },
  { href: "/menuly/dashboard/analytics", label: "Analytics", shortLabel: "Analytics", Icon: ChartIcon },
];
    ...
    <div className="flex min-h-screen w-full flex-col bg-cream text-navy lg:flex-row">
      ...
      <header className="flex items-center justify-between border-b border-navy/10 bg-white px-4 py-3 lg:hidden">
        <Link href="/admin" className="flex items-center gap-2">
          ...
          <span className="font-display text-lg tracking-tight text-navy">Menuly</span>
        </Link>
        <Link
          href="/admin"
